...
<div class="container py-4">
  <div class="d-flex justify-content-between align-items-center mb-4">
    <div>
      ...
      <p class="text-muted small mb-0">
        <?= $cestaAtiva ? htmlspecialchars($cestaAtiva['nome']) : 'Nenhuma cesta ativa' ?>
      </p>
    </div>
    <a href="/index.php?pagina=vitrine" class="btn btn-outline-primary">
  ...
  <?php if (!$cestaAtiva): ?>
    <div class="alert alert-warning">
      Você não tem cesta ativa. <a href="/index.php?pagina=cestas">Crie uma cesta</a>.
    </div>
      ...
      <div class="col-lg-4">
        <div class="card p-4">
          ...
          <a href="/index.php?pagina=carrinho&acao=esvaziar"
             ...
             onclick="return confirm('Esvaziar toda a cesta?')">
            🗑 Esvaziar carrinho
          </a>
        </div>
      </div>
